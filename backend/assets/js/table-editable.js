    ...
    return {
        ...
        init: function () {
            ...
            function editRow(oTable, nRow) {
                ...
                jqTds[filas].innerHTML = '<a class="edit" href=""><i class="fa fa-edit"></i></a> <a class="cancel" href=""><i class="fa fa-edit"></i></a>';
            }
            ...
            $('#editable-sample_new').click(function (e) {
                ...
                console.log($('#editable-sample'));
                /* var nFilas = $('>th', oTable.node('tr')[0]);
                console.log(nFilas); */
