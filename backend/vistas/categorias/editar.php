...
<?php
    ...
    if (isset($_GET['id']) && $_GET['id'] ==! "") {
        ...
        if ((isset($_POST['descripcion']) && $_POST['descripcion'] ==! ""))
        {
            ...
            $resp = $CategoriaCollectorObj->updateCategoria($_GET['id'], $_POST['descripcion']);

            if ($resp == true) {
                $msg = "La categoria fue modificada con éxito";
                $guardado = true;
            } else {
                $msg = "Error:".$resp;
            }
        ...
        $msg = "No ha llegado ningún ID de categoría";
        $guardado = false;
    }
?>
            ...
            <div class="col-sm-12">
                <section class="panel">
                    ...
                    <?php
                        ...
                        <div class="panel-body">
                            <h2><?=$msg?></h2>
                            <a href="index.php">Volver a categoria</a>
                        </div>
                        <?php
                    }
                    ?>
